...
- **Autorización y Control de Acceso:** No hay "tags públicos". La operación de filtrar por tags parte de una validación de permisos de lectura (`r`) exhaustiva tanto sobre la ruta raíz de la búsqueda como sobre cada uno de los archivos evaluados al descender, omitiendo silenciosamente aquellos para los que el usuario activo carece de acceso efectivo. La actualización de tags, como ocurre con la gestión de permisos en sí, es una operación de control de metadatos exenta de validación lógica de escritura para permitir acciones administrativas.
